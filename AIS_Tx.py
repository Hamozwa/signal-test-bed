...
class AIS_Tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "AIS_Tx")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\Lab\\Documents\\Simulator\\output_data.bin', True, 0, 0)
...
def main(top_block_cls=AIS_Tx, options=None):
